...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">VENTAS y PRODUCTOS</h1>
                    </div>
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <br>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Facturas registradas
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
 ...
 <div class="container-fluid">
    ...
    <p class="mb-4">Esta tabla muestra las ventas registradas.</p>
